...
class DesignCollapsible extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <section className="panel">
        <div
          ...
          data-id="designid"
          onClick={this.props.collapsibleAction}
        >
          <div className="title-image__wrapper">
            <img className="dropdown__icon-section" src={icoUngroup} alt="" />
            <h2 className="dropdown__title">Diseña</h2>
          </div>
          <img
            className={`${
              this.props.isCollapsibleOpen === "designid"
                ? "dropdown__arrow--up"
        ...
        <div
          className={`panel__design-radios panel--openFlex ${
            this.props.isCollapsibleOpen === "designid" ? "" : "panel--close"
          }`}
        >
...
export default DesignCollapsible;
